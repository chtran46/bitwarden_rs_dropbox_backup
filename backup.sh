...
tar -czf - /tmp/db.sqlite3 /data/attachments /data/rsa_key* /data/icon_cache | openssl enc -e -aes256 -salt -pbkdf2 -pass pass:${BACKUP_ENCRYPTION_KEY} -out /tmp/${BACKUP_FILE}.tar.gz
